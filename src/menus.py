...
def add_item_navigator(menu_name):
    ...
    if menu_name == "Product":
        sql_cmds.add_item_to_db(menu_name, name = item_name(menu_name), attribute = add_item_second_attr(menu_name,"price"))
        print(f"\n\n{menu_name} updated!\n\n")
        ...
        frequent.clear()
        sql_cmds.add_item_to_db(menu_name, name = item_name(menu_name), attribute = add_item_second_attr(menu_name,"phone number"))
...
def update_item_navigator(menu_name):
    ...
    if menu_name == "Product":
        index = update_item_index_selector(menu_name,id_list = caches.product_ids_list) 
        ...
        index = update_item_index_selector(menu_name,id_list = caches.courier_ids_list) 
        name = update_item_name(menu_name, index)
        attribute = update_item_attribute(menu_name, index)
...
def delete_item_navigator(menu_name):
    if menu_name == "Product":
        try:
            sql_cmds.delete_item(menu_name, item_index = delete_item_index_selector(menu_name, id_list = caches.product_ids_list))
            print(f"\n\n{menu_name} deleted!\n\n")
